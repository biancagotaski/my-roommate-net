...
namespace MyRoommate.API.Controllers
{
    public class RoomsController : ApiController
    {
        ...
        public IHttpActionResult GetRoom(Guid id)
        {
        ...
        public IHttpActionResult PutRoom(Guid id, Room room)
        {
        ...
        // DELETE: api/Rooms/5
        [ResponseType(typeof(Room))]
        public IHttpActionResult DeleteRoom(Guid id)
        {
            Room room = db.Rooms.Find(id);
            if (room == null)
            {
